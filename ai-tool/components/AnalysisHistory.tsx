...
// Client-side analysis history translations.
...
const InputModeIcon = ({mode}: { mode: InputMode }) => {
    switch (mode) {
        case 'text':
            return (
...
const HistoryHeader = ({hasHistory, onClearHistory, onClose, t}: HistoryHeaderProps) => (
...
const EmptyHistoryState = ({t}: { t: any }) => (
...
const HistoryItem = ({entry, onLoadEntry, onDeleteEntry, t}: HistoryItemProps) => (
    <div
        ...
        <div className="flex items-start gap-3 mb-3">
            <div className="flex-shrink-0 p-2 bg-gradient-to-br from-blue-500 to-purple-500 text-white rounded-lg">
                <InputModeIcon mode={entry.inputMode}/>
            </div>
...
export function AnalysisHistory({
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 dark:bg-black/70 backdrop-blur-sm animate-fadeIn">
            <div
                className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 w-full max-w-[90%] max-height-[90vh] max-h-[90vh] mx-4 flex flex-col animate-scaleIn">
                <HistoryHeader
