...
export function ReadingComplexityChart({ readingLevel }: ReadingComplexityChartProps) {
  ...
  return (
    <div className="w-full relative overflow-hidden bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/20 dark:to-cyan-950/20 p-6 rounded-xl border border-teal-200/50 dark:border-teal-800/50">
      <div className="relative z-10 space-y-5">
        ...
        <div className="space-y-3">
          ...
          <div className="relative h-10 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden shadow-inner">
            ...
            >
              {/* Indicator handle */}
              <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-5 h-5 bg-white dark:bg-zinc-100 rounded-full border-2 border-teal-600 dark:border-teal-400 shadow-lg flex items-center justify-center">
      ...
      {/* Decorative glow */}
      <div className={`absolute -right-8 -bottom-8 w-32 h-32 bg-gradient-to-r ${category.color} opacity-10 dark:opacity-15 rounded-full blur-3xl`}></div>
    </div>
  );
}
